...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between mb-2">
            <a href="{{ route('diskon') }}" class="btn" style="background-color: #073B4C; color: #ffffff">Tambah</a>
        </div>
            ...
            <tbody>
                @foreach ($voucher as $item)
                    <tr>
                        ...
                        <td width="150px">
                            <a href="{{ route('editDiskon', $item->id) }}" class="btn" style="background-color: #096a87; color: #ffffff">Edit</a>
